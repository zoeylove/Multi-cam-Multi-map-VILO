...
namespace ov_msckf {
    ...
    public:
         ...
         */
        UpdaterZeroVelocity(UpdaterOptions &options, Propagator::NoiseManager &noises, FeatureDatabase* db,Eigen::Vector3d gravity, double zupt_max_velocity, double zupt_noise_multiplier,double zupt_max_disparity)
                            : _options(options), _noises(noises), _db(db), _gravity(gravity), _zupt_max_velocity(zupt_max_velocity), _zupt_noise_multiplier(zupt_noise_multiplier), _zupt_max_disparity(zupt_max_disparity) {
        ...
        bool try_update(State *state, double timestamp, bool is_static);
