...
namespace ov_msckf {
    ...
    public:
        ...
        struct UpdaterHelperFeature {
            ...
            /// Tony modify Which camera to querry
            int querry_cam_id = -1;
        ...
        //version of multi map of kf5 norm
        static bool get_feature_jacobian_kf5_multi_map_norm(State* state, UpdaterHelperFeature &feature, Eigen::MatrixXd &H_f, Eigen::MatrixXd &H_n, Eigen::MatrixXd &H_x, Eigen::VectorXd &res, std::vector<Type*> &n_order,std::vector<Type*> &x_order);
