...
void TrackDescriptor::feed_new_camera(double timestamp, cv::Mat &img_left, cv::Mat &img_right, size_t cam_id_left, size_t cam_id_right, \
                                 cv::Mat &img1, size_t cam_id1, cv::Mat &img2, size_t cam_id2,bool use_stereo )
{
    //TODO check if use stereo mode
    feed_stereo(timestamp, img_left,img_right, cam_id_left, cam_id_right);
    feed_monocular(timestamp, img1, cam_id1);
    feed_monocular(timestamp, img2, cam_id2);
}
