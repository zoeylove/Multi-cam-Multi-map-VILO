...
namespace ov_core {
    ...
    public:
        ...
        virtual void feed_new_camera(double timestamp, cv::Mat &img_left, cv::Mat &img_right, size_t cam_id_left, size_t cam_id_right, \
                                 cv::Mat &img1, size_t cam_id1, cv::Mat &img2, size_t cam_id2, bool use_stereo) = 0;
