...
namespace ov_core{
    ...
    public:
        ...
        //TODO now only support one camera
        bool PnPRANSAC2d(const vector<cv::Point2f> &matched_2d_cur,
                       const std::vector<cv::Point3f> &matched_3d_kf,
        ...
        bool selected = false; //selected as keyframe;
        bool checked = false;  //have been checked whether have loop closure;
        ...
        map<double, size_t> matched_id_map;
        map<double, PoseJPL> query_cam_pose_map;
        ...
        size_t cam_id;
        //TONY add
        size_t querry_cam_id;
        double get_loopkfs_time;
        size_t matched_cam_id;
