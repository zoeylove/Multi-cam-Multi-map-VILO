...
int main(int argc, char** argv)
{
    ...
    for(int file_num=0;file_num<files.size();file_num++)
    {
        ...
        {
         if(line_number%2==1) // imagename1,imagename2,match number
         {
            ...
            image_name_back=image_name1.substr(10,4); // 2 for kaist, 4 for euroc
            ...
            if(image_poses.find(timestamp1)==image_poses.end())//load pose
            {
                ...
                while(getline(if_pose,str1))
                {
                    ...
                    timestamp= floor(timestamp*10000)/10000.0; // 2 for kaist,4 for euroc
            ...
            if(image_poses.find(timestamp2)==image_poses.end())//load pose
            {
                ...
                while(getline(if_pose,str1))
                {
                    ...
                    timestamp= floor(timestamp*10000)/10000.0;
